...
export function BirthdayCard({
  ...
  useFrame((_, delta) => {
    ...
    if (isActive) {
      ...
      scaleTarget.set(ACTIVE_SCALE, ACTIVE_SCALE, ACTIVE_SCALE);
    } else {
      ...
      scaleTarget.set(CARD_SCALE, CARD_SCALE, CARD_SCALE);
    }
    ...
    group.scale.lerp(scaleTarget, lerpAlpha);
  });
    ...
    <group ref={groupRef}>
      <group rotation={[0, 0, 0]}>
        ...
        >
          ...
          {/* Dark overlay behind the image to improve readability */}
